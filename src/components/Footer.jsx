...
export default function Footer() {
    ...
    mobile:items-start'>
       {/* above 1st*/}
        <div className='flex-1 flex flex-col flex-wrap p-2'>{/*after this div*/} 
            {/*Store infomation */}
            <h1 className='text-[25px] '>{/*3rd */}
                NokolasSarma
            </h1>
            <p >{/**4th */}
            ...
            <div className='flex items-center justify-center mt-3 self-start'>{/*5th social div */}
